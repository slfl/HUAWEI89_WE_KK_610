...
#if defined(OTM9605A_QHD_TIANMA) | defined(OTM9608A_QHD_TIANMA) | defined(NT35516_QHD_TRULY)
#ifdef BUILD_LK
...
#ifdef BUILD_LK
    dprintf(CRITICAL,"which_lcd_module,lcd_id0:%d\n",lcd_id0);
    dprintf(CRITICAL,"which_lcd_module,lcd_id1:%d\n",lcd_id1);
#else
...
#ifdef BUILD_LK
    dprintf(CRITICAL,"which_lcd_module,lcd_id:%d\n",lcd_id);
#else
