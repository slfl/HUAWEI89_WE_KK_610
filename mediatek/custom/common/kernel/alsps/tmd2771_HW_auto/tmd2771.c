...
int tmd2771_setup_eint(struct i2c_client *client)
{
    ...
    mt_eint_registration(CUST_EINT_ALS_NUM, CUST_EINT_ALS_DEBOUNCE_EN, tmd2771_eint_func, 0);
...
static int tmd2771_i2c_probe(struct i2c_client *client, const struct i2c_device_id *id)
{
   ...
   else if(((board_id & HW_VER_MAIN_MASK) == HW_G610U_VER)||((board_id & HW_VER_MAIN_MASK) == HW_G610U_VER))
   {
